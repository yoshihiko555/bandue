# Generated by Django 3.0.4 on 2020-06-07 11:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Upadate Date')),
                ('deleted', models.BooleanField(default=False, verbose_name='Delete Flag')),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='retweet_author', to=settings.AUTH_USER_MODEL)),
                ('hashTag', models.ManyToManyField(blank=True, to='api.HashTag')),
                ('liked', models.ManyToManyField(blank=True, related_name='retweet_liked', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Tweet',
            fields=[
                ...
                ('relation', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.Retweet')),
                ('retweet_user', models.ManyToManyField(blank=True, related_name='tweet_retweet_user', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Tag',
        ...
        migrations.AddField(
            model_name='retweet',
            name='relation',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.Tweet'),
        ),
        migrations.AddField(
            model_name='retweet',
            name='retweet_user',
            field=models.ManyToManyField(blank=True, related_name='retweet_retweet_user', to=settings.AUTH_USER_MODEL),
        ),
        migrations.CreateModel(
            name='Reply',
            fields=[
