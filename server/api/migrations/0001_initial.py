# Generated by Django 3.0.4 on 2020-06-17 12:43
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, primary_key=True, serialize=False)),
                ('room_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='room_id', to='api.Room')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, primary_key=True, serialize=False)),
                ('content', models.TextField(verbose_name='Content')),
                ('image', models.ImageField(blank=True, null=True, upload_to=api.models.content_file_name, verbose_name='Image')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sex', models.IntegerField(blank=True, choices=[(0, '指定なし'), (1, 'Male'), (2, 'Famale')], null=True)),
                ('age', models.IntegerField(blank=True, choices=[(0, '指定なし'), (1, '~19'), (2, '20~29'), (3, '30~39'), (4, '40~49'), (5, '50~59'), (6, '60~69'), (7, '70~79'), (8, '80~89'), (9, '90~99')], null=True)),
                ('is_public', models.BooleanField(default=False, verbose_name='Public Flag')),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
