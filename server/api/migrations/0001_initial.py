# Generated by Django 2.2.5 on 2020-06-02 22:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('retweet_user', models.ManyToManyField(blank=True, related_name='retweet_retweet_user', to=settings.AUTH_USER_MODEL)),
                ('target_tweet', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.Tweet')),
            ],
        ),
        migrations.CreateModel(
            name='Reply',
