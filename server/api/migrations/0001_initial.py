# Generated by Django 3.0.4 on 2020-06-16 12:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sex', models.IntegerField(blank=True, choices=[(1, 'Male'), (2, 'Famale'), (3, 'Unspecified')], null=True)),
                ('age', models.IntegerField(blank=True, choices=[(1, '~19'), (2, '20~29'), (3, '30~39'), (4, '40~49'), (5, '50~59'), (6, '60~69'), (7, '70~79'), (8, '80~89'), (9, '90~99'), (10, 'Unspecified')], null=True)),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
