# Generated by Django 2.2.5 on 2020-06-07 23:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('retweet_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tweet_retweet_user', to=settings.AUTH_USER_MODEL)),
                ('retweets', models.ManyToManyField(blank=True, to='api.Tweet')),
            ],
        ),
        migrations.CreateModel(
            name='Tag',
